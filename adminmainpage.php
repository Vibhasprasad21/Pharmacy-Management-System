...
<body>
	...
	<a href="buttons.php" title="Queries">
<img src="q.png" style="padding:8px;margin-left:100px;margin-top:40px;width:200px;height:200px;border:2px solid black;" alt="Total Sales">
	</a>
